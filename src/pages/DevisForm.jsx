...
useEffect(() => {
  const loadData = async () => {
    try {
      ...
      // Extraire les tableaux de la clé "data"
  ...
  // Si on est en mode édition (id présent)
  if (id) {
...
const updateLigneProduit = (index, field, value) => {
  ...
  try {
    ...
    if (id) {
      ...
      // 👉 Récupérer l'id du devis créé (selon ton backend ça peut être created.id ou created.devis.id)
      ...
      {/* Header Section */}
        ...
        <div>
          <h2 className="fw-bold text-primary mb-2">
            ...
            {id ? "Modifier le Devis" : "Créer un Nouveau Devis"}
          </h2>
          <p className="text-muted mb-0">
            {id ? "Modifiez les informations de votre devis" : "Remplissez les informations pour créer un nouveau devis"}
          </p>
        </div>
            ...
            <Card className="border-0 shadow-sm h-100" style={{ maxWidth: "100%" }}>
              ...
              <Card.Body className="p-4">
                ...
                <Row className="g-3 mb-4">
                  <Col md={6}>
                    <Form.Group>
                      <Form.Label className="fw-semibold text-muted">Date de Création</Form.Label>
                      <InputGroup>
                        <InputGroup.Text className="bg-white border-end-0">
        ...
        <Card className="border-0 shadow-sm mb-4" style={{ maxWidth: "100%" }}>
          ...
          <Card.Body className="p-0">
              ...
              <div className="text-center py-5">
                ...
                <p className="text-muted mb-3">Commencez par ajouter des services à votre devis</p>
                <Button 
                  variant="outline-success" 
                  onClick={()=>setShowServiceModal(true)}
                  className="rounded-pill"
        ...
        <Card className="border-0 shadow-sm mb-4" style={{ maxWidth: "100%" }}>
          ...
          <Card.Body className="p-0">
              ...
              <div className="text-center py-5">
                ...
                <p className="text-muted mb-3">Commencez par ajouter des produits à votre devis</p>
                <Button 
                  variant="outline-warning" 
                  onClick={()=>setShowProduitModal(true)}
                  className="rounded-pill"
            ...
            <Row className="g-3">
              ...
              <Col md={3}>
                <div className="text-center p-3 bg-primary bg-opacity-10 rounded-3 border border-primary">
                  <div className="text-primary small fw-semibold">NET À PAYER</div>
